...
class Grafo_h1:
    ...
    gov_jorge_teixeira = Vertice('Governador Jorge Teixeira', 89.43)
    cacaulandia = Vertice('Cacaulândia', 118.64 )
    theobrama = Vertice('Theobrama', 82.28)
    vale_do_anari = Vertice('Vale do Anari', 115.02)
    machadinho_d_oeste = Vertice('Machadinho D`Oeste', 160.94)
    cujubim = Vertice('Cujubim', 180.90)  ### duas rotas
    rio_crespo = Vertice('Rio Crespo', 165.64)
    alto_paraiso = Vertice('Alto Paraíso', 196.47)
    monte_negro = Vertice('Monte Negro', 161.63)
    campo_novo_de_rondonia = Vertice('Campo Novo de Rondônia', 184.44)
    buritis = Vertice('Buritis', 217.09)
    itapua_do_oeste = Vertice('Itapuã do Oeste', 230.68)
    candeias_do_jamari = Vertice('Candeias do Jamari', 299.57)
    porto_velho = Vertice('Porto Velho', 316.36)
    nova_mamore = Vertice('Nova Mamoré', 372.26)  ###duas rotas
    guajara_mirim = Vertice('Guajará-Mirim', 369.54)  ###duas rotas

    vilhena = Vertice('Vilhena', 287.95)
    chupinguaia = Vertice('Chupinguaia', 220.08)  ###duas rotas
    colorado_do_oeste = Vertice('Colorado do Oeste', 293.48)
    cabixi = Vertice('Cabixi', 329.50)
    cerejeiras = Vertice('Cerejeiras', 285.57)
    corumbiara = Vertice('Corumbiara', 260.73)  ###duas rotas
    pimenteiras_do_oeste = Vertice('Pimenteiras do Oeste', 306.51)
...
class Grafo_h3:
    ...
    pimenta_boeno = Vertice('Pimenta Bueno',165*1)
    urupa = Vertice('Urupá',85*1)
    novo_horizonte = Vertice('Novo Horizonte do Oeste',130*1.1)
    nova_brasilandia = Vertice('Nova Brasilândia D. Oeste',150*1.1)
    sao_miguel = Vertice('São Miguel do Guaporé',160*1.2)
    seringueiras = Vertice('Seringueiras',190*1.2)
    sao_francisco = Vertice('São Francisco do Guaporé',240*1.2)
    costa_marques = Vertice('Costa Marques',330*1.2)
    santa_luzia = Vertice('Santa Luzia D. Oeste',140*1.1)
    ...
    alto_alegre_do_parecis = Vertice('Alto Alegre dos Parecis',180*1.1)
    jaru = Vertice('Jaru',90*1)
    ariquemes = Vertice('Ariquemes',170*1)

    gov_jorge_teixeira = Vertice('Governador Jorge Teixeira', 120*1.1)
    cacaulandia = Vertice('Cacaulândia', 150*1.1)
    theobrama = Vertice('Theobrama', 110*1.1)
    vale_do_anari = Vertice('Vale do Anari', 161*1.1)
    machadinho_d_oeste = Vertice('Machadinho D`Oeste', 216*1.2)
    cujubim = Vertice('Cujubim', 250*1.2)  ### duas rotas
    rio_crespo = Vertice('Rio Crespo', 194*1.1)
    ...
    vilhena = Vertice('Vilhena', 285*1)
    chupinguaia = Vertice('Chupinguaia', 268*1.1)  ###duas rotas
    colorado_do_oeste = Vertice('Colorado do Oeste', 338*1)
    cabixi = Vertice('Cabixi', 378*1.1)
    cerejeiras = Vertice('Cerejeiras', 374*1.1)
    corumbiara = Vertice('Corumbiara', 366*1.1)  ###duas rotas
    pimenteiras_do_oeste = Vertice('Pimenteiras do Oeste', 418*1.2)
